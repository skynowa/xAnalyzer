...
) /* override */
{
	...
	std::ctstring_t             defines        = _dataIn.defines;      xUNUSED(defines);
	AnalyzerDataIn::cCompilerId compilerId     = _dataIn.compilerId;
	...
	std::map<AnalyzerDataIn::CompilerId, std::tstring_t> argsStdlib
	{
		{AnalyzerDataIn::CompilerId::Clang, "-stdlib=libstdc++"},
		{AnalyzerDataIn::CompilerId::Gcc,   ""}
	};
